...
export const usePagination = ({
	...
	const paginationRange = useMemo(() => {
		...
		/*
		  ...
		  paginationComponent, we simply return the range [1..totalPageCount]
		*/
		...
		/*
		  We don't show dots just when there is just one page number to be inserted between the extremes of sibling and the page limits i.e 1 and totalPageCount.
		  So we're using leftSiblingIndex > 2 and rightSiblingIndex < totalPageCount - 2
		*/
		...
		*/
		...
		// Default case, should not be reached often
		return [];
